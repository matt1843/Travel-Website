...
scrollTriggerAnimation(".travel", [
  ".travel .box1, .travel .box2, .travel .box3",
]);

scrollTriggerAnimation(".feedback .container", [
  ".feedback .label, .feedback .heading, .feedback .paragraph",
]);

scrollTriggerAnimation(".destinations", [
  ".destinations .heading, .destinations .content",
]);
